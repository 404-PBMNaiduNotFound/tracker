...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-C5e3935C.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-m_nj9vvi.js"),
		import("./start-DkBq7kgL.js"),
...
var ROUTER_BASEPATH = "dsatracker";
var SERVER_FN_BASE = "/dsatracker/_serverFn/";
