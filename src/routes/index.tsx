      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div className="rounded-xl border border-border bg-card p-5 flex flex-col gap-1">
            ...
            <p className="font-mono text-4xl font-bold text-foreground tabular-nums">474</p>
            <p className="text-xs text-muted-foreground">Striver A2Z sheet</p>
          </div>
          ...
          <div className="rounded-xl border border-border bg-card p-5 flex flex-col gap-1">
            ...
            <p className="font-mono text-4xl font-bold text-foreground tabular-nums">18</p>
            <p className="text-xs text-muted-foreground">topic-wise sections</p>
          </div>
          ...
          <div className="rounded-xl border border-border bg-card p-5 flex flex-col gap-1">
            ...
            <p className="font-mono text-4xl font-bold text-foreground tabular-nums">~4</p>
            <p className="text-xs text-muted-foreground">avg across 120 days</p>
          </div>

          {/* Card 4 — Checklist Steps */}
          <div className="rounded-xl border border-border bg-card p-5 flex flex-col gap-1">
            <p className="font-mono text-[10px] tracking-widest uppercase text-muted-foreground">
              Checklist Steps
            </p>
            <p className="font-mono text-4xl font-bold text-foreground tabular-nums">12</p>
            <p className="text-xs text-muted-foreground">per problem, per day</p>
          </div>
  ...
  const cards = [
    {
      ...
      bullets: [
        ...
        "Google Search button on every problem — open a targeted search for tutorials and explanations instantly",
      ],
      mock: null,
    },
    {
    ...
    },
    {
      ...
      bullets: [
        ...
        "Google Search button on every problem row — find solutions and explanations in one click",
      ],
      mock: <ProblemsMock />,
    },
    {
          ...
          <div className="flex-1 min-w-0">
            ...
            <ul className="space-y-2">
              {[
                ...
                "Every problem also has a Google Search button — find solutions, editorials, and video explanations without leaving your flow",
              ].map((b) => (
                <li key={b} className="flex gap-2 text-sm text-muted-foreground">
                  <span className="text-primary mt-0.5 shrink-0">›</span>
                  <span>{b}</span>
    ...
    <section className="py-24 border-t border-border">
      <div ref={ref} className="mx-auto max-w-5xl px-4 text-center cta-inner">
        ...
        <p className="mt-6 text-xs text-muted-foreground font-mono">
          ✓ Free forever&nbsp; · &nbsp;✓ svs s SSyncs across devices&nbsp; · &nbsp;✓ Built on Striver's A2Z sheet
        </p>
      </div>
    </section>
  );
