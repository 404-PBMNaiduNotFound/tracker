 ...
 * TUF migrated most articles from category-specific paths (/sorting/,
 * /linked-list/, /bit-manipulation/, /stack-queue/, /heap/, /dynamic-programming/, etc.)
 * to /data-structure/ paths.
 */
export const TUF_LINKS: Record<string, string> = {
  ...
  "Patterns: Rectangular Star Pattern":            "https://takeuforward.org/pattern/pattern-1-rectangular-star-pattern",
  "Patterns: Right-Angled Triangle":               "https://takeuforward.org/pattern/pattern-2-right-angled-triangle-pattern",
  "Patterns: Right-Angled Number Triangle":        "https://takeuforward.org/pattern/pattern-3-right-angled-number-pyramid",
  "Patterns: Inverted Right Pyramid":              "https://takeuforward.org/pattern/pattern-5-inverted-right-pyramid",
  "Patterns: Floyd's Triangle":                    "https://takeuforward.org/pattern/pattern-4-right-angled-number-pyramid-ii",
  "Patterns: Inverted Numeric Right Triangle":     "https://takeuforward.org/pattern/pattern-6-inverted-numbered-right-pyramid",
  "Patterns: Star Pyramid":                        "https://takeuforward.org/pattern/pattern-7-star-pyramid",
  "Patterns: Inverted Star Pyramid":               "https://takeuforward.org/pattern/pattern-8-inverted-star-pyramid",
  "Patterns: Diamond Star Pattern":                "https://takeuforward.org/pattern/pattern-9-diamond-star-pattern",
  "Patterns: Half Diamond Star Pattern":           "https://takeuforward.org/pattern/pattern-10-half-diamond-star-pattern",
  "Patterns: Binary Number Triangle":              "https://takeuforward.org/pattern/pattern-11-binary-number-triangle-pattern",
  "Patterns: Number Crown":                        "https://takeuforward.org/pattern/pattern-12-number-crown-pattern",
  "Patterns: Increasing Letter Triangle":          "https://takeuforward.org/pattern/pattern-14-increasing-letter-triangle-pattern",
  "Patterns: Reverse Letter Triangle":             "https://takeuforward.org/pattern/pattern-15-reverse-letter-triangle-pattern",
  "Patterns: Alpha-Ramp Pattern":                  "https://takeuforward.org/pattern/pattern-17-alpha-ramp-pattern",
  "Patterns: Alpha-Hill Pattern":                  "https://takeuforward.org/pattern/pattern-18-alpha-hill-pattern",
  "Patterns: Symmetric Void Pattern":              "https://takeuforward.org/pattern/pattern-20-symmetric-void-pattern",
  "Patterns: Star Butterfly Pattern":              "https://takeuforward.org/pattern/pattern-21-star-butterfly-pattern",
  "Patterns: Hollow Rectangle":                    "https://takeuforward.org/pattern/pattern-22-hollow-rectangle-pattern",
  "Patterns: Concentric Rectangle":               "https://takeuforward.org/pattern/pattern-23-concentric-rectangle-pattern",
  ...
  "Selection Sort":                                "https://takeuforward.org/data-structure/selection-sort-algorithm",
...
export function getTufLink(name: string): string {
  return (
    TUF_LINKS[name] ??
    `https://takeuforward.org/?s=${encodeURIComponent(name)}`
  );
}

/** Returns the TUF article URL only if a real entry exists, otherwise null */
export function getTufLinkOrNull(name: string): string | null {
  return TUF_LINKS[name] ?? null;
}