...
export function DayCard({ day, showSkipAction }: { day: Day; showSkipAction?: boolean }) {
  ...
  return (
    <div
      className={cn(
        "relative rounded-xl border border-border bg-card p-4 transition-colors hover:border-primary/50",
    ...
    >
      ...
      >
        ...
        <h3 className="mt-1 font-display text-base font-semibold">{day.topic}</h3>
