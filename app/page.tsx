    ...
    <section className="relative overflow-hidden py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-5xl px-4">
        <p className="mb-4 font-mono text-xs tracking-[0.2em] text-primary uppercase">
          Striver A2Z · 474 problems · 18 sections · your pace, your plan
        </p>
        ...
        <p className="hero-sub mt-6 max-w-2xl text-base text-muted-foreground leading-relaxed">
          A daily problem checklist built from Striver's A2Z DSA sheet — tuned to fit <em>your</em> life.
          ...
          Life happens — postpone a day, skip a topic, or insert a revision day and the schedule rebalances automatically.
        </p>
        ...
        <div className="hero-terminal mt-14 max-w-lg rounded-xl border border-border bg-card shadow-lg overflow-hidden">
          ...
          <div className="p-5 font-mono text-sm leading-7">
            ...
            <p>
              ...
              <span className="text-foreground font-semibold">Day 1</span>
            </p>
            <p>
...
function StatsBar() {
  ...
  const c4pace = useCountUp(4);
  const c4 = useCountUp(12);

  const stats = [
    { ref: c474, value: 474, label: "Problems" },
    { ref: c18, value: 18, label: "Sections" },
    { ref: c4, value: 4, label: "Problems / day", prefix: "~" },
    { ref: c4, value: 12, label: "Checklist steps" },
  ];
  ...
  const steps = [
    {
      ...
      body: "Pick your start date and your daily pace (e.g. 4 Easy + 3 Medium + 2 Hard). Your personal schedule is generated instantly from Striver's A2Z sheet — 474 problems across 18 sections, ordered by topic, starting the day you choose.",
      step: "01",
    },
    {
      icon: ListTodo,
    ...
    <section className="py-24 border-t border-border">
      <div ref={ref} className="mx-auto max-w-5xl px-4 text-center cta-inner">
        ...
        <p className="mt-6 text-xs text-muted-foreground font-mono">
          ✓ Free forever&nbsp; · &nbsp;✓ Syncs across devices&nbsp; · &nbsp;✓ Built on Striver's A2Z sheet
        </p>
      </div>
    </section>
  );
