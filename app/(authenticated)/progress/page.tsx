...
export default function ProgressPage() {
  ...
  const stats = useMemo(() => {
    ...
    // Grand total including skipped (so student sees full picture)
    const grandTotal = total + skippedProblems + pbTotal;
    const remaining = grandTotal - combinedDone;
    return {
      total,
      done,
  ...
  return (
    <>
      ...
      <div className="mb-4 grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        />
        <Stat label="Problems left" value={String(stats.remaining)} />
